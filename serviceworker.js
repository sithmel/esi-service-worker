(function () {
  ...
  class TransparentStreamStateWriter extends TransparentStateWriter {
    /**
   ...
   */
  async function fetchAndStream$1(request) {
  ...
  class ESIStreamStateWriter extends TransparentStreamStateWriter {
    /**
     * @param {WritableStream} writable
     * @param {(arg0:string) => Promise<ReadableStream<Uint8Array>|null>} fetchFunction
     */
    constructor(writable, fetchFunction = fetchAndStream$1) {
      super(writable);
   ...
   * @returns {Promise<void>}
   */
  async function parseReadableStream(readable, state) {
